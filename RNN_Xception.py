...
IMAGE_ROOT = '/Users/yueshu/Documents/course\ 498\ deep\ learning\ 2017fall/HW3RNN/flickr30k_images/flickr30k_images'
TRAIN_CAPTION_PATH = '/Users/yueshu/Documents/course\ 498\ deep\ learning\ 2017fall/HW3RNN/flickr30k_images/train.txt'
TEST_CAPTION_PATH = '/Users/yueshu/Documents/course\ 498\ deep\ learning\ 2017fall/HW3RNN/flickr30k_images/test.txt'
...
class Image_Caption(object):
    ...
    def pred_sentence(self, pra_datagen):
        predicts = self.model.predict(pra_datagen.generate(True),batch_size = 10, berbose = 1)
        print (predicts)
        f = file('words.txt','a+')
        f.write(predicts)
        f.write("\n")
...
if __name__ == '__main__':
    ...
    model.pred_sentence(my_generator)
